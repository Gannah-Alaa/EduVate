...
<div class="landing d-flex align-items-center" id="home">
      ...
      <div class="left-container col-md-6 m-5">
        ...
        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Aperiam fugiat placeat blanditiis, vel aliquid, dolore exercitationem nulla ullam similique rem odio eius in..</p>
        <div class="left-buttons">
            <button type="button" class="btn btn-warning">Primary</button>
            <button type="button" class="btn btn-outline-warning ms-3">Primary</button>
