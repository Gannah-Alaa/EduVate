 <?php
    ...
    if(isset($_POST['forgot'])){
        ...
        $selectF = "SELECT * FROM `students` WHERE `StudentEmail`='$emaill'";
...
if(isset($_POST['login'])){
    ...
    if(empty($email) || empty($pass)){
        ...
        if ($rows>0){
            ...
            $fetch_em=$fetch['StudentEmail'];
            $fetchPass=$fetch['StudentPass'];
...
?> 
    ...
    <body >
        ...
        <div class=" d-flex justify-center items-center col-md-5 row p-5">
            ...
            <div class="">
                <p class="fs-5 text-center p-2">I am a Student</p>
