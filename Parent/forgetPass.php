...
if(isset($_POST['submit'])){
    ...
    $msg="Hello your OTP is $rand";
         ...
         // php mail start->>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
$mail->setFrom('notyourbusiness.960@gmail.com', 'Eduvate');          //sender mail address , website name
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-4">
                                        ...
                                        <h3 class="hs fs-6 fw-normal text-secondary m-0">Provide the email address associated with your account to recover your password.</h3>
                                    </div>
                                </div>
                            </div>
                            <!-- ---------------------------------------form start---------------------------------- -->
                                ...
                                <div class="row gy-3 overflow-hidden">
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex justify-content-center">
                                            <button class="btn btn-primary btn-lg" type="submit" name="submit">Forgot Password</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
