 <?php
    ...
    if(isset($_POST['forgot'])){
        ...
        $selectF = "SELECT * FROM `parents` WHERE `ParentEmail`='$emaill'";
    ...
    if(isset($_POST['login'])){
        ...
        if(empty($email) || empty($pass)){
            ...
            if ($rows>0){
                ...
                $fetch_em=$fetch['ParentEmail'];
                $fetchPass=$fetch['ParentPass'];
    ...
    <body >
        ...
        <div class=" d-flex justify-center items-center col-md-5 row p-5">
            ...
            <div class="">
                <p class="fs-5 text-center p-2">I am a Parent</p>
        ...
        <div class="rightside text-white col-md-5  d-flex flex-column justify-content-evenly align-items-lg-stretch row ">
            <h3 class="text-center abril-fatface-regular ">Stop struggling with common tasks and focus on the real choke points.</h3>
