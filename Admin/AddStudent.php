            ...
            <div class="container">
                <div class="form-section">
                    ...
                    <form method="post" id="studentForm">
                        ...
                        <div class="form-group">
                            <label>Bus Subscription</label>
                            <div class="radio-group">
                                <label class="radio-option">
                                    <input type="radio" name="bussub" value="1" id="yes">
                                    <span>Yes</span>
                                </label>
                                <label class="radio-option">
                                    <input type="radio" name="bussub" value="0" id="no" checked>
                                    <span>No</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select id="bus" name="bus">
                                ...
                                <?php foreach($runBus as $option){?>
                                <option value="<?php echo $option['BusID'];?>"><?php echo $option['BusNumber']. " - ". $option['Destination'];?></option>
                                <?php } ?>
                            </select>
                        </div>
